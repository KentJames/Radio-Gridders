...
static inline std::complex<double> deconvolve_visibility_(std::vector<double> uvw,
					   double du,
					   double dw,
					   int aa_support_uv,
					   int aa_support_w,
...
int main(int argc, char **argv){
    ...
    std::vector<std::vector<double> > uvwvec = generate_random_visibilities(theta,lambda,4.3,npts);
